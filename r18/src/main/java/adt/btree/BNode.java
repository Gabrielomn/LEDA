...
//		int m = this.size()/2;
//		T mediana = this.getElementAt(m);
//
//		BNode<T> left = new BNode<>(this.getMaxChildren());
//		for(int i = 0; i <= m; i++){
...
//		}
//
//		BNode<T> right = new BNode<>(this.getMaxChildren());
//		for(int i = m+1; i < this.getChildren().size(); i++){
//			right.addChild(i - (m - 1), this.getChildren().get(i));
//		}
//
//		for(int i = m + 1; i < this.getElements().size(); i++){
//			right.addElement(this.getElementAt(i));
//		}
//
//
//		if(this.getParent() == null){//sou raiz
...
//
//		this.promote();
//		if(this.parent.size() >= this.getMaxChildren()){
//			this.parent.split();
//		}
//
//
